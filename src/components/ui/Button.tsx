...
/* The string `'inline-flex items-center justify-center rounded-md text-sm font-medium
ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2
focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none
disabled:opacity-50'` is defining a set of CSS classes that will be used as the base styles for the
...
`Button` component. */
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          ' whitespace-nowrap bg-primary text-lg text-primary-foreground shadow-2xl shadow-blue-700 rounded-lg ',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-slate-900 hover:bg-white hover:text-black',
        secondary:
        ...
        'btn-secondary':
          'whitespace-nowrap dark:text-white text-lg font-normal',
      },
      size: {
